...
if (!empty($_POST)) {
    ...
    if (isset($_POST['br_rad']) && $_POST['bg_color'] != "") {
        $br_rad = htmlspecialchars($_POST['bg_color']);
    }
...
<form action="minusait.php" method="post">
    ...
    <div style="border-style: solid; border-color: silver; border-width: 2px; border-right-style: hidden; margin: 10px">
        ...
        <br>
        <input type="range" name="br_width" min="0" max="20">Piirjoone laius (0-20px)<br>
        ...
        <input type="range" name="br_width" min="0" max="100"  value='<?php echo "$br_width"; ?>'> Piirjoone nurga raadius (0-100px)<br>
    </div>
